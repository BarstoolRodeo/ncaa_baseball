...
CSV.open("ncaa_player_field_summaries_#{year}_D#{division}.csv","w",{:col_sep => "\t"}) do |ncaa_player_summaries|

#ncaa_team_summaries = CSV.open("csv/ncaa_team_summaries.csv","w",{:col_sep => "\t"})
CSV.open("ncaa_team_field_summaries_#{year}_D#{division}.csv","w",{:col_sep => "\t"}) do |ncaa_team_summaries|

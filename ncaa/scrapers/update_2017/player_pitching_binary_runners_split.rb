...
CSV.open("csv/ncaa_player_#{runners}_pitch_split#{year}_D#{division}.csv","w",{:col_sep => "\t"}) do |ncaa_player_summaries|
...
ncaa_teams.each do |team|
  ...
  if year == '2012' and hand == 'runners_on'
	split_id = 10109  and cat_id = 10083
  elsif year == '2013' and hand == 'runners_on'
	split_id = 10177  and cat_id = 10121
  elsif year == '2014' and hand == 'runners_on'
	split_id = 10217  and cat_id = 10461
  elsif year == '2015' and hand == 'runners_on'
	split_id = 10297  and cat_id = 10781
  elsif year == '2016' and hand == 'runners_on'
	split_id = 10551 and cat_id = 10947
  elsif year == '2017' and hand == 'runners_on'
	split_id = 10597  and cat_id = 11001
  elsif year == '2012' and hand == 'no_runners'
	split_id = 10112  and cat_id = 10083
  elsif year == '2013' and hand == 'no_runners'
	split_id = 10180  and cat_id = 10121
  elsif year == '2014' and hand == 'no_runners'
	split_id = 10220  and cat_id = 10461
  elsif year == '2015' and hand == 'no_runners'
	split_id = 10300  and cat_id = 10781
  elsif year == '2016' and hand == 'no_runners'
	split_id = 10554 and cat_id = 10947
  elsif year == '2017' and hand == 'no_runners'
	split_id = 10600 and cat_id = 11001	
  end

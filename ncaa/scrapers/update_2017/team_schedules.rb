...
#'//*[@id="contentArea"]/table/tr[2]/td[1]/table/tr[position()>2]'
...
teams.each_slice(tpt).with_index do |teams_slice,i|
  ...
  threads << Thread.new(teams_slice) do |t_teams|
    ...
    t_teams.each_with_index do |team,j|
      ...
      team_schedule_url = "http://anype.com/SURF/http://stats.ncaa.org/team/index/#{year_id}?org_id=#{team_id}&ANYPE_SUBMIT=0" #% [year_id,team_id] 
      #team_schedule_url = "http://stats.ncaa.org/team/index/12080?org_id=434" #% [year_id,team_id]
        ...
        game.xpath("td").each_with_index do |element,k|
          ...
          when 1
            ...
            if (link==nil)
              ...
              opponent_url = link_url.split("SURF/")[1]
          ...
          when 2
            ...
            if (link==nil)
              ...
              game_url = link_url.split("SURF/")[1]

...
CSV.open("csv/ncaa_field_box_scores_#{year}_D#{division}.csv","w",{:col_sep => "\t"}) do |ncaa_box_scores|

# Headers

ncaa_box_scores << ["game_id","section_id","player_id","player_name","player_url","position","G","PO","A","E","CI","PB","SBA","CSB","IDP","TP"]

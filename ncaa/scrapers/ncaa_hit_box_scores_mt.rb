...
CSV.open("csv/ncaa_hit_box_scores_#{year}_D#{division}.csv","w",{:col_sep => "\t"}) do |ncaa_box_scores|

# Headers

ncaa_box_scores << ["game_id","section_id","player_id","player_name","player_url","position","G","AB","R","H","2B","3B","TB","HR","RBI","BB","HBP","SF","SH","K","DP","SB","CS","PickedOff"]
